class TurnsController < ApplicationController
  ...
  def show
    ...
    turn.requests.each do |request|
      if request.status == "Accepted"
        @passengers.push(request.user.email)
      end
    end
  end
  ...
  def create
    ...
    @turn = current_user.turns.new(turn_params)
  ...
  private
    ...
    def turn_params
      params.require(:turn).permit(:weekday, :departure_address, :departure_time, :turn_type, :people_limit, :address)
    end
end
